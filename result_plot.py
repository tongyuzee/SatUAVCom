...
if __name__ == "__main__":
    compare_rates(
        'data/Whole_Service_S2_U3_N4_M6400_Random0.npy', 'RIS with optimized-phase elements',
        'data/Whole_Service_S2_U3_N4_M6400_Random1.npy', 'RIS with random-phase elements',
        'data/Whole_Service_S2_U3_N4_M0_Random0.npy', 'Without RIS',
        output_name="RIS_comparison",
        colors=['#1d73b6', '#24a645', '#898989'],
        markerfacecolors=['#1d73b6', 'none', '#898989'],
        styles=['-', '--', '--'],
        markers=['o', 'o', '+' ],
        ylims=[8.4, 12.4],
